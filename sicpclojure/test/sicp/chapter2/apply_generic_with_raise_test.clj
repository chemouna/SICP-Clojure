...
(deftest test-raise-to
  (is (= (raise-to 'real 'rational (rat/make-rational 2 5)) (real/make-real 2/5)))
  (is (= (raise-to 'rational 'integer (int/make-integer 2)) (rat/make-rational 2 1)))
  (is (= (raise-to 'complex 'integer (int/make-integer 2)) (c/make-complex-from-real-imag 2 0)))
  (is (= (raise-to 'complex 'rational (rat/make-rational 2 3)) (c/make-complex-from-real-imag 2/3 0)))
